...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','main.py',69),
  ...
  ('expression -> expression MODULO expression','expression',3,'p_expression_binop','main.py',81),
  ('expression -> expression FLOOR expression','expression',3,'p_expression_binop','main.py',82),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','main.py',101),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','main.py',105),
  ('expression -> NUMBER','expression',1,'p_expression_number','main.py',109),
  ('expression -> NAME','expression',1,'p_expression_name','main.py',113),
]
